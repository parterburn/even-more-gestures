...
- `codesign --verify --deep --strict` and stapler validation pass on the `0.2.18 (21)` Developer ID-signed bundle with hardened runtime and secure timestamps, including the embedded Sparkle framework.
...
- The `0.2.18` build was accepted by Apple’s Notary service and stapled. Its GitHub Release archive is Sparkle-signed and listed in the repository appcast.
