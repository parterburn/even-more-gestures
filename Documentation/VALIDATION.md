...
- `codesign --verify --deep --strict` passes on the `0.2.0 (3)` Developer ID-signed bundle with hardened runtime and secure timestamps, including the embedded Sparkle framework.
